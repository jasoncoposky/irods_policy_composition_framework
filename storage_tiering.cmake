...
add_library(
    ${TARGET_NAME}
    MODULE
    ${CMAKE_SOURCE_DIR}/${POLICY_NAME}.cpp
...
set(IRODS_PLUGIN_VERSION "4.2.7.0")
...
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_POLICY_NAME_UPPERCASE}_PACKAGE_DEPENDS "${IRODS_PACKAGE_DEPENDENCIES_STRING}, irods-server (= ${IRODS_VERSION}), irods-runtime (= ${IRODS_VERSION}), irods-rule-engine-plugin-policy-engine-access-time (= ${IRODS_PLUGIN_VERSION}), irods-rule-engine-plugin-policy-engine-data-restage (= ${IRODS_PLUGIN_VERSION}), irods-rule-engine-plugin-policy-engine-tier-group-metadata (= ${IRODS_PLUGIN_VERSION}), libc6")
...
if (IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "centos" OR IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "centos linux")
    ...
    set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_POLICY_NAME}_PACKAGE_REQUIRES "${IRODS_PACKAGE_DEPENDENCIES_STRING}, irods-server = ${IRODS_VERSION}, irods-runtime = ${IRODS_VERSION}, openssl, irods-rule-engine-plugin-policy-engine-access-time = ${IRODS_PLUGIN_VERSION}), irods-rule-engine-plugin-policy-engine-data-restage = ${IRODS_PLUGIN_VERSION}, irods-rule-engine-plugin-policy-engine-tier-group-metadata = ${IRODS_PLUGIN_VERSION}")
elseif (IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "opensuse")
    set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_POLICY_NAME}_PACKAGE_REQUIRES "${IRODS_PACKAGE_DEPENDENCIES_STRING}, irods-server = ${IRODS_VERSION}, irods-runtime = ${IRODS_VERSION}, libopenssl1_0_0, irods-rule-engine-plugin-policy-engine-access-time = ${IRODS_PLUGIN_VERSION}), irods-rule-engine-plugin-policy-engine-data-restage = ${IRODS_PLUGIN_VERSION}, irods-rule-engine-plugin-policy-engine-tier-group-metadata = ${IRODS_PLUGIN_VERSION}")
endif()
